...
function rk_home_popup( $atts, $content = null ) {
    ...
    $output .= '<figure class="wp-block-image size-full "><img src="http://localhost/balibeach/wp-content/themes/meru/assets/img/arunika.jpg" alt="" class="wp-image-9999"></figure>';
    $output .= '</div>';
